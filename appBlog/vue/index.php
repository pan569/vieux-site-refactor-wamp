...
<p class="text-right"><a href="<?=  $this->routeur->getRoute('ajouter')->generateUri(); ?>">ajouter</a></p>
<ul>
<?php foreach ( $model as $item): ?>
    <li>
    	<a href="<?= $this->routeur->getRoute('montrer')->generateUri(['id' => $item['id']]);?>"><?= e($item['titre']); ?></a>
