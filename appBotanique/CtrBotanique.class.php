 ...
 * Time: 05:59
 *
 * Phase 7 : CSRF + messages flash sur toutes les actions d'écriture.
 */
...
class CtrBotanique extends Controleur
{
    ...
    public function ajouterFamille(array $variables)
    {
        ...
        if (array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables)) {
            ...
            if ($model->INSERT()) {
                $this->flashSucces('Famille ajoutée.');
                $Callback = 'indexFamille';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible d\'ajouter la famille.');
        }
    ...
    public function editerFamille(array $variables)
    {
        ...
        if (array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables)) {
            ...
            if ($model->UPDATE()) {
                $this->flashSucces('Famille modifiée.');
                $Callback = 'indexFamille';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible de modifier la famille.');
        }
    ...
    public function supprimerFamille(array $variables)
    {
        ...
        if (array_key_exists('method', $variables)) {
            ...
            $model->DELETE();
            $this->flashSucces('Famille supprimée.');
            $Callback = 'indexFamille';
            $variableCallback = [];
            $this->redirigerRoute(compact('Callback', 'variableCallback'));
        }
    ...
    public function ajouterGenre(array $variables)
    {
        ...
        if (array_key_exists('ID_FAMILLE', $variables) || array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables)) {
            ...
            if ($model->INSERT()) {
                $this->flashSucces('Genre ajouté.');
                $Callback = 'indexGenre';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible d\'ajouter le genre.');
        }
    ...
    public function editerGenre(array $variables)
    {
        ...
        if (array_key_exists('ID_FAMILLE', $variables) || array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables)) {
            ...
            if ($model->UPDATE()) {
                $this->flashSucces('Genre modifié.');
                $Callback = 'indexGenre';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible de modifier le genre.');
        }
    ...
    public function supprimerGenre(array $variables)
    {
        ...
        if (array_key_exists('method', $variables)) {
            ...
            $model->DELETE();
            $this->flashSucces('Genre supprimé.');
            $Callback = 'indexGenre';
            $variableCallback = [];
            $this->redirigerRoute(compact('Callback', 'variableCallback'));
        }
    ...
    public function ajouterEspece(array $variables)
    {
        ...
        if (array_key_exists('ID_GENRE', $variables) || array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables)) {
            ...
            $this->traiterUploadsImagesEspece($model);

            if ($model->INSERT()) {
                $this->flashSucces('Espèce ajoutée.');
                $Callback = 'indexEspece';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible d\'ajouter l\'espèce.');
        }
    ...
    public function editerEspece(array $variables)
    {
        ...
        if (array_key_exists('ID_GENRE', $variables) || array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables)) {
            ...
            if ($model->UPDATE()) {
                $this->flashSucces('Espèce modifiée.');
                $Callback = 'indexEspece';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible de modifier l\'espèce.');
        }
    ...
    public function supprimerEspece(array $variables)
    {
        ...
        if (array_key_exists('method', $variables)) {
            ...
            $model->DELETE();
            $this->flashSucces('Espèce supprimée.');
            $Callback = 'indexEspece';
            $variableCallback = [];
            $this->redirigerRoute(compact('Callback', 'variableCallback'));
        }
    ...
    /**
     * Factorise le traitement des uploads d'images pour Espece.
     */
    protected function traiterUploadsImagesEspece(Espece $model): void
    {
        $champs = ['ENSEMBLE', 'FEUILLE', 'FLEUR', 'FRUIT', 'TIGE', 'RACINE', 'ECORSE'];

        foreach ($champs as $champ) {
            if (!empty($_FILES[$champ]['tmp_name']) && is_uploaded_file($_FILES[$champ]['tmp_name'])) {
                if ($_FILES[$champ]['size'] <= 500000) {
                    $model->set($champ, file_get_contents($_FILES[$champ]['tmp_name']));
                }
            }
        }
    }
    ...
    public function ajouterPlante(array $variables)
    {
        ...
        if (array_key_exists('ID_ESPECE', $variables)) {
            ...
            $this->traiterUploadsImagesPlante($model);

            if ($model->INSERT()) {
                $this->flashSucces('Plante ajoutée.');
                $Callback = 'indexPlante';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
            $this->flashErreur('Impossible d\'ajouter la plante.');
        }
    ...
    public function editerPlante(array $variables)
    {
        ...
        if (array_key_exists('ID_GENRE', $variables) || array_key_exists('LATIN', $variables) || array_key_exists('FRANCAIS', $variables) || array_key_exists('ID_ESPECE', $variables)) {
            if ($this->refuserSiCsrfInvalide()) {
            ...
            if (method_exists($model, 'UPDATE') && $model->UPDATE()) {
                $this->flashSucces('Plante modifiée.');
                $Callback = 'indexPlante';
                $variableCallback = [];
                $this->redirigerRoute(compact('Callback', 'variableCallback'));
            }
    ...
    protected function traiterUploadsImagesPlante(Plante $model): void
    {
        $champs = ['ENSEMBLE', 'FEUILLE', 'FLEUR', 'FRUIT', 'TIGE', 'RACINE', 'ECORSE'];
    ...
    {
        if (!empty($_FILES[$nomEtiquette]['tmp_name']) && is_uploaded_file($_FILES[$nomEtiquette]['tmp_name'])) {
    ...
    public function supprimerPlante(array $variables)
    {
        ...
        if (array_key_exists('method', $variables)) {
            ...
            $model->DELETE();
            $this->flashSucces('Plante supprimée.');
            $Callback = 'indexPlante';
            $variableCallback = [];
            $this->redirigerRoute(compact('Callback', 'variableCallback'));
        }
